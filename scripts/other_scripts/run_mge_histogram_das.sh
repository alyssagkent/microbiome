...
-o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESH}_mgetaxa.txt
...
head -1 ${PATIENT}_das_${CONTACT_THRESH}_mgetaxa.txt > Together_das_${CONTACT_THRESH}_mgetaxa_together.txt
tail -n +2 -q *_das_${CONTACT_THRESH}_mgetaxa.txt >> Together_das_${CONTACT_THRESH}_mgetaxa_together.txt
