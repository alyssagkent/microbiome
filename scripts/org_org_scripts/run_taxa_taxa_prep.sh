...
GENE=arg
THRESH=2
python ${SCRIPTFOLD}/taxa_taxa_prep.py -i /workdir/users/agk85/CDC2/bins/histogram_figures/Together_das_${THRESH}_${GENE}taxa_together.txt -o /workdir/users/agk85/CDC2/bins/${GENE}_das_${THRESH}_taxa_taxa_counts.txt
