...
setwd("/workdir/users/agk85/CDC/arg_v_org/metagenomes3/patric_comparisons")
infile = read.table("arg_patric_distribution.txt",sep="\t", header=T)
...
pdf("ARG_PATRIC_comparison.pdf", height = 5, width=8)
