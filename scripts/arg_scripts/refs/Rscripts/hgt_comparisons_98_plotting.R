...
indata = read.table(paste("hgt_comparisons_alllevels_allorgs_",pid,".txt",sep=""),header=F, sep="\t")
...
cm
write.table(cm, paste("ARG_HGT_statistics_",pid,".txt",sep=""), sep="\t")

pdf(paste("ARG_HGT_comparisons_all_",pid,".pdf",sep=""), useDingbats=F,height = 5, width =8)
