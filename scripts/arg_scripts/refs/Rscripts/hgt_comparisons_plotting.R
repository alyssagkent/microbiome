...
setwd("/workdir/users/agk85/CDC/arg_v_org/metagenomes3/hgt_comparisons")


indata = read.table("hgt_comparisons_alllevels_allorgs.txt",header=F, sep="\t")
...
cm
write.table(cm, "ARG_HGT_statistics.txt", sep="\t")

pdf("ARG_HGT_comparisons_all.pdf", useDingbats=F,height = 5, width =8)
...
write.csv(indata, "arg_hgt_comparisons_alllevels_ratio.txt")
