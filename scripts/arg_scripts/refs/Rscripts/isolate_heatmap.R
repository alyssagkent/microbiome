...
g = read_graph('/workdir/users/agk85/CDC/tables/metagenomes4/mge_isolate_99_ncol.txt',directed=FALSE, format = c("ncol"))
...
orgs = unique(organisms)[order(unique(organisms))]
...
pdf("Isolate_shared_genes.pdf", height=20,width=20)
heatmap.2(new_df,density.info="none",trace="none",hclustfun=myclust,
col=my_palette, Rowv=T, Colv=T, dendrogram="both",
