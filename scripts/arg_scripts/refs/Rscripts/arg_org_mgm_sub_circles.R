...
###################################################################
setwd("/workdir/users/agk85/CDC/arg_v_org/metagenomes3/mgm_sub_cliques")
depth = 1
...
indata = read.csv(paste("arg_org_mgm_cliques_95_98_",depth, "_2.tbl",sep=""), header=T, sep="\t",row.names=1)
