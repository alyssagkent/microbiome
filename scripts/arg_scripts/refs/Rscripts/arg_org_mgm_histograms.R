...
setwd("/workdir/users/agk85/CDC/arg_v_org/metagenomes3/mgm_histograms")
...
pdf(paste("All_ARG_ORG_MGM_histogram_no0_",delimname,"_with2.pdf",sep=""), height = 20, width =15)
