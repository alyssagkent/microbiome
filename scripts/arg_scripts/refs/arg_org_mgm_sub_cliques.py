...
from best_org_mgm import best_org
...
outhandle = '{0}/arg_v_org/metagenomes3/mgm_sub_cliques/arg_org_mgm_cliques_{1}_{2}_{3}_{4}.tbl'.format('/workdir/users/agk85/CDC' , '95' , '98' ,str(args.depth), str(2))
