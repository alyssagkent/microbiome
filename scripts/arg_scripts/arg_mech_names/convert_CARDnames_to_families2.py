...
#do this before
#os.system("cat ~/agk/" + folder + "/card/metagenomes/*/*.txt | grep -v '^ORF_ID' > ~/agk/" + folder + "/args/all_card.txt")

names = '/workdir/users/agk85/' + folder + '/args/mapping/bwa_alignments_' + argpid + '_' + argpid + '/arg_v_samp_' + argpid + '_' + argpid + '_names.txt'
mechhandle = '/workdir/users/agk85/' + folder + '/args/arg_v_samp_' + argpid + '_' + argpid + '_names_mech.txt'
clstrhandle = '/workdir/users/agk85/' + folder + '/args/args_' + argpid + '_nr.fna.clstr'
...
resfam_handle='/workdir/users/agk85/' + folder + '/args/resfams_prot_id_type.txt'
card_handle='/workdir/users/agk85/' + folder + '/args/all_card.txt'
...
"Fluoroquinolone-resistant DNA topoisomerases":"Quinolone Resis`tance",
