...
snakemake -s ${WRK}/scripts/arg_scripts/snake_arg_index --jobs $JOBS --restart-times $RESTARTS --cluster "qsub -q long.q@cbsubrito2 -S /bin/bash -e $ERR -o $ERR -wd ${WRK}/arg_v_org/metagenomes/ -N {params.n} -l h_vmem={resources.mem_mb}G"
