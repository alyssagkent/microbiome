...
-o ${WRK}/bins_hicsupport/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt

cd  $WRK/bins_hicsupport

head -1 ${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt > Together_das_${CONTACT_THRESHOLD}_argtaxa_together.txt
tail -n +2 -q *_das_${CONTACT_THRESHOLD}_argtaxa.txt >> Together_das_${CONTACT_THRESHOLD}_argtaxa_together.txt
