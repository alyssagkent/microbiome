...
#sim-1_mge_count.bac120.summary.tsv	
#these currently have the wrong cluster names! need to redo once rerunning network and checkm
# gtdb_bin_taxonomy = {}
...
######This is the hic supports version
#so either you are not in it and there are hic supports
#you are in it but you have hic supports to other contigs
#or you are in it and have no hic supports to other contigs
		...
		for bin in bins:
			...
			if contig1 in bincontigsdict[bin]:
				...
				if contigcount>args.min:
					association_type='cluster_resident_withhicsupport'
				else:
					association_type = 'cluster_resident_withouthicsupport'
			else:
