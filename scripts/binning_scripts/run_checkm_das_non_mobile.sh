#$ -S /bin/bash
#$ -N checkm
#$ -e /workdir/users/agk85/CDC2/logs/maxbin_checkm_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC2/logs/maxbin_checkm_$JOB_ID.out
#$ -t 1-37
#$ -V
...
FOLDER=$WRK/das/${NAME}/${NAME}_DASTool_non_mobile_bins
OUT=$WRK/das/${NAME}/checkm_lineage_non_mobile
