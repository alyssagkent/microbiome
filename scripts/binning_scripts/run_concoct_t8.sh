#$ -S /bin/bash
#$ -N Concoct_t8
#$ -e /workdir/users/agk85/CDC2/logs/concoct_t8_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC2/logs/concoct_t8_$JOB_ID.out
#$ -t 1
#$ -V
...
DESIGN_FILE=$WRK/concoct/MetaDesign_t8.txt
...
/workdir/users/agk85/tools/CONCOCT/scripts/concoct_coverage_table.py ${OUT}/${NAME}_contigs_10K.bed $WRK/mapping/mapping_t8/${PATIENT}*/*.sorted.bam  > ${OUT}/${NAME}_coverage_table.tsv
