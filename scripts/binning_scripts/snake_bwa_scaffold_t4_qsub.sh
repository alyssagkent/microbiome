...
#$ -V
#$ -t 1
#$ -e /workdir/users/agk85/CDC2/logs/snake-bwa_t4_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC2/logs/snake-bwa_t4_$JOB_ID.out
...
#--restart-times 2
FOLDER=CDC2
SCRIPT=/workdir/users/agk85/${FOLDER}/scripts/binning_scripts/snake_bwa_scaffold_t4
RESTARTS=1
JOBS=8
