...
mat3<-mat2[mat2 < thresh] <- 0
print(sum(mat2))

my_palette <- colorRampPalette(c("white", "blue", "purple","red"))(n = 100)
my_palette  <- c("white", colorRampPalette(c("blue", "red"))(n=100))
...
write.csv(mat2, paste("Heatmap_counts_",taxa, "_",method,".txt",sep=""))
