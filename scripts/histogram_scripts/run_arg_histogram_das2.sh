...
CONTACT_THRESHOLD=2
PATIENT=B314
python $WRK/scripts/arg_histogram_prep.py -i ${WRK}/bins/${PATIENT}-1_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-2_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-3_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-4_das_${CONTACT_THRESH}_contigs_v_bins.txt -o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt -a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD}


PATIENT=B316
python $WRK/scripts/arg_histogram_prep.py -i ${WRK}/bins/${PATIENT}-1_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-2_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-3_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-4_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-5_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-6_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-7_das_${CONTACT_THRESH}_contigs_v_bins.txt -o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt -a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD}

PATIENT=B320
python $WRK/scripts/arg_histogram_prep.py -i ${WRK}/bins/${PATIENT}-1_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-2_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-3_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-5_das_${CONTACT_THRESH}_contigs_v_bins.txt -o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt -a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD}

PATIENT=B331
python $WRK/scripts/arg_histogram_prep.py -i ${WRK}/bins/${PATIENT}-1_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-2_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-3_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-4_das_${CONTACT_THRESH}_contigs_v_bins.txt -o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt -a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD}

PATIENT=B335
python $WRK/scripts/arg_histogram_prep.py -i ${WRK}/bins/${PATIENT}-1_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-2_das_${CONTACT_THRESH}_contigs_v_bins.txt,${WRK}/bins/${PATIENT}-3_das_${CONTACT_THRESH}_contigs_v_bins.txt -o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt -a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD}
...
-a ${WRK}/args/args_99_nr.fna.clstr.tbl -p ${PATIENT} -c ${CONTACT_THRESHOLD} \
-o ${WRK}/bins/${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt

#Rscript $WRK/scripts/histogram_arg_plotting.R $WRK/bins/${PATIENT}_das_${CONTACT_THRESH}_argtaxa.txt $WRK/bins/${PATIENT}_das_${CONTACT_THRESH}_argtaxa.txt 
...
#head -1 Numbers_${CONTACT_THRESH}_B314.txt > histogram_figures/ARG_histogram_numbers_${CONTACT_THRESH}.txt
#tail -n +2 -q Numbers*.txt >> histogram_figures/ARG_histogram_numbers_${CONTACT_THRESH}.txt

#head -1 Taxa_Count_Numbers_${CONTACT_THRESH}_B314.txt > histogram_figures/ARG_histogram_taxa_count_numbers_${CONTACT_THRESH}.txt
#tail -n +2 -q Taxa_Count_Numbers*.txt >> histogram_figures/ARG_histogram_taxa_count_numbers_${CONTACT_THRESH}.txt

#head -1 Metrics_${CONTACT_THRESH}_B314.txt > histogram_figures/ARG_histogram_metrics_${CONTACT_THRESH}.txt
#tail -n +2 -q Metrics*.txt >> histogram_figures/ARG_histogram_metrics_${CONTACT_THRESH}.txt


head -1 ${PATIENT}_das_${CONTACT_THRESHOLD}_argtaxa.txt > histogram_figures/Together_das_${CONTACT_THRESHOLD}_argtaxa_together.txt
tail -n +2 -q *_das_${CONTACT_THRESHOLD}_argtaxa.txt >> histogram_figures/Together_das_${CONTACT_THRESHOLD}_argtaxa_together.txt
