...
OUTFILE=$WRK/bins2/${NAME}_das_${CONTACT_THRESH}_contigs_v_bins.txt
HIC=$WRK/hicpro/output/${NAME}_output/hic_results/data/${NAME}/${NAME}_trans_primary_0_ncol_noeuks_normalize_${CONTACT_THRESH}.txt
