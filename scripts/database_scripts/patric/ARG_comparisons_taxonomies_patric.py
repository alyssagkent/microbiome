...
#this is what it should look like, but add now to the taxid python script taxid_to_taxonomy['1739443']='k__Bacteria; p__Proteobacteria; c__Betaproteobacteria; o__Burkholderiales; f__Alcaligenaceae; g__Achromobacter; s__Achromobacter_sp._HMSC056C09;'
...
#delims = ['s__']
outhandle = '/workdir/users/agk85/CDC2/bins/patric_figures/arg_' + minreads + '_onlyhic_patric_distribution.txt'
