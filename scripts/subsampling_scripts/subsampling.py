...
with open(args.hic) as hicfile, open(args.outhandle2,'w') as outfile2, open(args.outhandle5,'w') as outfile5, open(args.outconbin2,'w') as outconbin2, open(args.outconbin5,'w') as outconbin5:
