...
outhandle = '/workdir/users/agk85/CDC2/bins/flickering/{0}_org_flickering_{1}_{2}.txt'.format(args.genetype, level, str(args.minreads))
connected_dict = {}
unconnected_dict = {}
...
for sample in samples:
	...
	for connection in connections:
		...
		try:
			done = assessed[sample][taxonomy][gene]
		except KeyError:
